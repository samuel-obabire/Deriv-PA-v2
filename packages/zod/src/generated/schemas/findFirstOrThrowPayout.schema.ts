...
export const PayoutFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PayoutSelect> = z.object({
...
export const PayoutFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    amount: z.boolean().optional(),
    recipientName: z.boolean().optional(),
    recipientAccount: z.boolean().optional(),
