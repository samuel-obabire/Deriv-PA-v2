...
export const WithdrawalRequestFindUniqueSchema: z.ZodType<Prisma.WithdrawalRequestFindUniqueArgs> = z.object({ select: WithdrawalRequestSelectObjectSchema.optional(), include: WithdrawalRequestIncludeObjectSchema.optional(), where: WithdrawalRequestWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.WithdrawalRequestFindUniqueArgs>;

export const WithdrawalRequestFindUniqueZodSchema = z.object({ select: WithdrawalRequestSelectObjectSchema.optional(), include: WithdrawalRequestIncludeObjectSchema.optional(), where: WithdrawalRequestWhereUniqueInputObjectSchema }).strict();