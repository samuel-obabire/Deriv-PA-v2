...
import { WithdrawalRequestUpdateOneWithoutPayoutNestedInputObjectSchema as WithdrawalRequestUpdateOneWithoutPayoutNestedInputObjectSchema } from './WithdrawalRequestUpdateOneWithoutPayoutNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  withdrawal: z.lazy(() => WithdrawalRequestUpdateOneWithoutPayoutNestedInputObjectSchema).optional()
}).strict();
export const PayoutUpdateInputObjectSchema: z.ZodType<Prisma.PayoutUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.PayoutUpdateInput>;
export const PayoutUpdateInputObjectZodSchema = makeSchema();
