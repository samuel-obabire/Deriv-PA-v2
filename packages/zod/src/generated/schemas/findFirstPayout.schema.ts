...
export const PayoutFindFirstSelectSchema: z.ZodType<Prisma.PayoutSelect> = z.object({
...
export const PayoutFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    amount: z.boolean().optional(),
    recipientName: z.boolean().optional(),
    recipientAccount: z.boolean().optional(),
