...
export const WithdrawalRequestFindManySelectSchema: z.ZodType<Prisma.WithdrawalRequestSelect> = z.object({
...
export const WithdrawalRequestFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    derivId: z.boolean().optional(),
    amount: z.boolean().optional(),
    amountNgn: z.boolean().optional(),
