...
export type TypeMap<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
        modelProps: "withdrawalRequest" | "payout";
...
export declare const WithdrawalRequestScalarFieldEnum: {
    readonly id: "id";
    readonly derivId: "derivId";
    readonly amount: "amount";
    readonly amountNgn: "amountNgn";
    readonly currency: "currency";
    readonly derivRef: "derivRef";
...
export declare const PayoutScalarFieldEnum: {
    ...
    readonly reciepientBank: "reciepientBank";
    readonly createdAt: "createdAt";
    readonly withdrawalRequestId: "withdrawalRequestId";
    readonly status: "status";
    readonly flagReason: "flagReason";
};
